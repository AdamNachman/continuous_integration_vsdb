// <copyright file="FullTextCatalog.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    public class FullTextCatalog : BaseDBObject
    {
        ...
        public FullTextCatalog(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sysfulltextcatalogs WHERE [name]='{0}')\r\nBEGIN\r\n", this.Name);
