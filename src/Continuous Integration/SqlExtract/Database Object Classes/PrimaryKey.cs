// <copyright file="PrimaryKey.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// </summary>
    public class PrimaryKey : ClusteredConstraint
    {
        #region Constructors
        ...
        public PrimaryKey(string parentName, string name, string ddl)
        ...
        /// <param name="name">The name of the constraint</param>
        /// <param name="ddl">The ddl of the object</param>
        public PrimaryKey(string schema, string parentName, string name, string ddl)
