// <copyright file="DatabaseSchema.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The DatabaseSchema class
    /// </summary>
    public class DatabaseSchema : BaseDBObject
    {
        #region Constructors
        ...
        public DatabaseSchema(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        protected override void LoadDdl(string ddl)
        {
            ...
            this.Body = "EXEC sp_executesql N'" + ddl + "'";
