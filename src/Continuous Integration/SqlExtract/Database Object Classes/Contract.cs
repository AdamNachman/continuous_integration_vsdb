// <copyright file="Contract.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    public class Contract : BaseDBObject
    {
        ...
        public Contract(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sys.service_contracts WHERE name = N'{0}')\r\nBEGIN\r\n", this.Name);
