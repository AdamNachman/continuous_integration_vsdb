// <copyright file="Service.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    public class Service : BaseDBObject
    {
        ...
        public Service(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sys.services WHERE name = N'{0}')\r\nBEGIN\r\n", this.Name);
