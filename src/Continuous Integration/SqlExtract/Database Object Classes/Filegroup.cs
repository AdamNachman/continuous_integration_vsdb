// <copyright file="Filegroup.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// The Filegroup class
    /// </summary>
    public class Filegroup : BaseDBObject
    {
        #region Constructors
        ...
        public Filegroup(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sys.filegroups WHERE [name]='{0}')\r\nBEGIN\r\n", this.Name);
