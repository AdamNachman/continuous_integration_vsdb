// <copyright file="PartitionFunction.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    public class PartitionFunction : BaseDBObject
    {
        ...
        public PartitionFunction(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sys.partition_functions WHERE [name]='{0}')\r\nBEGIN\r\n", this.Name);
