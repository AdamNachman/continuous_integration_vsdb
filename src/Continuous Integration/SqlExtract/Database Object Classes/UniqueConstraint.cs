// <copyright file="UniqueConstraint.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// </summary>
    public class UniqueConstraint : ClusteredConstraint
    {
        #region Constructors
        ...
        public UniqueConstraint(string parentName, string name, string ddl)
        ...
        /// <param name="name">The name of the constraint</param>
        /// <param name="ddl">The ddl of the object</param>
        public UniqueConstraint(string schema, string parentName, string name, string ddl)
