...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The DatabaseSynonym class
    /// </summary>
    public class DatabaseSynonym : BaseDBObject
    {
        #region Constructors
        ...
        public DatabaseSynonym(string name, string ddl)
            : base(name, ddl)
        {
        }
        ...
        {
            this.Prefix = string.Format("IF NOT EXISTS (SELECT * FROM sys.synonyms WHERE [name]='{0}')\r\nBEGIN\r\n", this.Name);
