// <copyright file="ProcessMessages.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessMessages class
    /// </summary>
    internal class ProcessMessages : ProcessDatabase
    {
        #region Constructors
        ...
        internal ProcessMessages(Database targetDatabase)
        ...
        internal ProcessMessages(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Messages.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting messages...");
