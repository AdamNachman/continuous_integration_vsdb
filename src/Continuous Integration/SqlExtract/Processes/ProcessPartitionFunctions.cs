// <copyright file="ProcessPartitionFunctions.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessPartitionFunctions class
    /// </summary>
    internal class ProcessPartitionFunctions : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessPartitionFunctions class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessPartitionFunctions(Database targetDatabase)
        ...
        internal ProcessPartitionFunctions(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "PartitionFunctions.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting partition functions...");
