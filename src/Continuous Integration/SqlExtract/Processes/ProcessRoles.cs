// <copyright file="ProcessRoles.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessRoles class
    /// </summary>
    internal class ProcessRoles : ProcessDatabase<Role>
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessRoles class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessRoles(Database targetDatabase)
        ...
        internal ProcessRoles(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Roles.sql");
            }
        }
        ...
        internal override void AddObject(Role newObject)
        {
        ...
        {
            Utilities.Logger.LogInformation("Extracting roles...");
