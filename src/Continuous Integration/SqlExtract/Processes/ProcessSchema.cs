// <copyright file="ProcessSchema.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// </summary>
    internal class ProcessSchema : ProcessDatabase<DatabaseSchema>
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessSchema class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessSchema(Database targetDatabase)
        ...
        internal ProcessSchema(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Schemas.sql");
            }
        }
        ...
        internal override void AddObject(DatabaseSchema newObject)
        {
        ...
        {
            Utilities.Logger.LogInformation("Extracting schema...");
