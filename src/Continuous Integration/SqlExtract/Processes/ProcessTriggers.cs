// <copyright file="ProcessTriggers.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessTriggers class
    /// </summary>
    internal class ProcessTriggers : ProcessDatabase<Trigger>
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessTriggers class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessTriggers(Database targetDatabase)
        ...
        internal ProcessTriggers(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Triggers.sql");
            }
        }
        ...
        internal override void AddObject(Trigger newObject)
        {
        ...
        {
            Utilities.Logger.LogInformation("Extracting triggers...");
