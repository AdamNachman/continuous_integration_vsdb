// <copyright file="ProcessFullTextIndexes.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessFullTextIndexes class
    /// </summary>
    internal class ProcessFullTextIndexes : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessFullTextIndexes class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessFullTextIndexes(Database targetDatabase)
        ...
        internal ProcessFullTextIndexes(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "FullTextIndexes.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting full text indexes...");
