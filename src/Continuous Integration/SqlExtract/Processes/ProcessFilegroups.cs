// <copyright file="ProcessFilegroups.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessFilegroups class
    /// </summary>
    internal class ProcessFilegroups : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessFilegroups class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessFilegroups(Database targetDatabase)
        ...
        internal ProcessFilegroups(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Filegroups.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting filegroups...");
