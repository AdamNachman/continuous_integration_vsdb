// <copyright file="ProcessServices.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessServices class
    /// </summary>
    internal class ProcessServices : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessServices class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessServices(Database targetDatabase)
        ...
        internal ProcessServices(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Services.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting services...");
