// <copyright file="ProcessPartitionScheme.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessPartitionScheme class
    /// </summary>
    internal class ProcessPartitionScheme : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessPartitionScheme class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessPartitionScheme(Database targetDatabase)
        ...
        internal ProcessPartitionScheme(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "PartitionScheme.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting partition schemes...");
