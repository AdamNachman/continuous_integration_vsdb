// <copyright file="ProcessRoutes.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessRoutes class
    /// </summary>
    internal class ProcessRoutes : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessRoutes class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessRoutes(Database targetDatabase)
        ...
        internal ProcessRoutes(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Routes.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting routes...");
