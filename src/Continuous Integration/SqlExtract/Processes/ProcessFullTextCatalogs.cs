// <copyright file="ProcessFullTextCatalogs.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessFullTextCatalogs class
    /// </summary>
    internal class ProcessFullTextCatalogs : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessFullTextCatalogs class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessFullTextCatalogs(Database targetDatabase)
        ...
        internal ProcessFullTextCatalogs(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "FullTextCatalogs.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting full text catalogs...");
