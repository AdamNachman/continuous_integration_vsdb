// <copyright file="ProcessContracts.cs" company="Adam Nachman">
...
namespace AdamNachman.Build.SqlExtract
{
    ...
    /// <summary>
    /// The ProcessContracts class
    /// </summary>
    internal class ProcessContracts : ProcessDatabase
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the ProcessContracts class
        /// </summary>
        /// <param name="targetDatabase">The database against which the processor will execute</param>
        internal ProcessContracts(Database targetDatabase)
        ...
        internal ProcessContracts(Database targetDatabase, bool appendDatabaseNameToScripts, string appendDatabaseName)
        ...
        internal override string FileName
        {
            get
            {
                return string.Concat(this.GetFilePrefix(), "Contracts.sql");
            }
        }
        ...
        {
            Utilities.Logger.LogInformation("Extracting contracts...");
